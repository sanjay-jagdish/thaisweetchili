...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="theordersbook">
    <thead>
        <tr>
            <th>Customer</th>
            <th>Date & Time</th>
    ...
    <tbody class="forbook-content">
     <?php
        
       $q=mysql_query("select rt.description, concat(a.fname,' ',a.lname), r.date, r.time, r.number_people, r.number_table, r.approve, r.id, rt.id, r.lead_time, r.acknowledged from reservation_type as rt, account as a, reservation as r where rt.id=r.reservation_type_id and a.id=r.account_id and r.deleted=0 and rt.id=1");
