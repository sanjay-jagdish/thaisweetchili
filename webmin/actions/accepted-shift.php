<?php
	...
	mysql_query("update shift_request set accepted = ".$_SESSION['login']['id'].", accept_time=NOW() where id = " . $id);
...
<style>
    ...
    Shift Rquest No. <?php echo $id; ?> has been accepted with you as part of it and is now pending approval.  Below are the details:<br /><br />
