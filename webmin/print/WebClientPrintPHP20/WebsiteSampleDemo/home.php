<?php
  ...
  $title = 'WebClientPrint 2.0 for PHP Demo';
?>
...
<table class="table table-bordered">
    <tr>
        <td><a href="DemoPrintCommands.php" class="btn btn-large btn-info" style="width:100px;height:35px;">Print Raw Commands</a></td>
    ...
    <tr>
        <td><a href="DemoPrintFile.php" class="btn btn-large btn-info" style="width:100px;height:35px;">Print Files</a></td>
