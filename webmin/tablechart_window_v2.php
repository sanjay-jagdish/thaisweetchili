...
function updateClock ( )
    {
    var currentTime = '<?php echo date('D M d Y H:i:s \G\M\TO (\C\E\T)'); ?>';//new Date ( );
...
.hour_th{ font-weight: regular !important; color:#000 !important; background-color:#EAEAEA !important; }
.min_th{ font-weight: regular !important; color:#000 !important; background-color:#fff !important; }
...
<div class="wrapper">
	...
	.new_waitlist_btn{
		float:left; text-align:center; height:20px; width:80px;  background-color:#FC9; height:20px; padding:5px; border-radius: 0px 10px 10px 0px;	
	}
    ...
    <div style="margin:0px 0px 15px 5px; width:700px; float: left;" id="legend_container">
    ...
    <div style="float:left; margin-top:-6px;">
      <div style="float:left; margin-left:12px; background-color:#FC9; height:20px; padding:5px; border-radius: 10px 0px 0px 10px;">
        <div style="float:left; width:80px; text-align:center;">Waiting List</div>
    </div>
    ...
    <table width="100%" border="0" style="border-collapse:collapse;">
    	<tr>
        	<td style="width:500px;"><div id="operation_details" style="float:left; width:210px; padding:0px 8px 8px 20px; line-height:15px;"> <strong><u>Information</u></strong><br>
        	  ...
        	  Bokningsintervall: <b><?php echo $res_det['time_interval']; ?> mins.</b> <br>
        	  Sittningsintervall: <b><?php echo $res_det['dine_interval']; ?> mins.</b> <br>
        	  Dukningsintervall: <b><?php echo $res_det['between_interval']; ?> mins.</b> <br>
  <div style="width:200px; border: solid thin 1px; margin-top:4px;"> Booking Summary:
    <style>
  ...
  <?php
	...
	?>
  <br>
  <a id="QBook" data-rel="<?php echo $date_selected.' '.$res_det['id']; ?>">Boka</a> <br>
  <?php
	}
	?>
      	  </div>        	  
          ...
          <div id="chartdate" style="float:left;"></div>
            ...
            <div class="container avails-grid" id="booking_by_time">
                ...
                <div class="table-reservations-list table-container show-table" style="position:relative; width:100%; height:200px;">
...
<div class="container avails-grid" id="table_chart">
    ...
    <div class="table-container" style="float:left; clear:left;">
    	...
    	<!-- <table cellpadding="0" cellspacing="0" border="0" class="compact hover table table-condensed table-chart table-bordered" style="clear:none !important;"> -->
    	<table cellpadding="0" cellspacing="0" border="0" class="compact table table-condensed table-chart table-bordered" style="clear:none !important;">
        	...
        	<thead>
				...
				while($time_h<=$end_h){
					if(date('i',$time_h)=='00'){
						$time_txt_h = '<font style="font-size:16px;"><b>'.date('H',$time_h).'</b></font>';
						$class_th = '';
                    ?>
				  <th style="width:70px;" class="<?php echo $class_th; ?>" colspan="<?php echo $hr_span; ?>">
					<?php 
					echo $time_txt_h;
					?>
                    </th>
