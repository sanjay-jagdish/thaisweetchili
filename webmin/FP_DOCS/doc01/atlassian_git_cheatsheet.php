...
<?php
	...
	$lic_key = '$f75f643f84a7a5a0e06';
	$authenticated = false || strrpos("!flexpaperyWjyxuFe2R","!flexpaper")>-1;
	if(isset($_POST['txt_flexpaper_password'])){$authenticated = $_POST['txt_flexpaper_password'] == '!flexpaperyWjyxuFe2R';} $auth_tried=isset($_POST['txt_flexpaper_password']) && !$authenticated;
?>
<!doctype html>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/flexpaper.css?1459615843654" />
    <link rel="stylesheet" type="text/css" href="css/popover.css?1459615843654" />
    <link rel="stylesheet" type="text/css" href="css/popover-theme.css?1459615843654" />
    <script type="text/javascript" src="js/jquery.min.js?1459615843654"></script>
    <script type="text/javascript" src="js/jquery.extensions.min.js?1459615843654"></script>
    <script type="text/javascript" src="js/popover.min.js?1459615843654"></script>
    <!--[if gte IE 10 | !IE ]><!-->
    <script type="text/javascript" src="js/three.min.js?1459615843654"></script>
    <!--<![endif]-->
    <script type="text/javascript" src="js/flexpaper.js?1459615843654"></script>
    <script type="text/javascript" src="js/flexpaper_handlers.js?1459615843654"></script>
</head>
<body>
    ...
    <script type="text/javascript">
        $('#documentViewer').FlexPaperViewer(
                { config : {
                    ...
                    TrackingNumber          : '',
                    key                     : '$f75f643f84a7a5a0e06',
                    signature               : 'e8b348cd80d0e7dfb3b686a7d717c44d',
                    localeChain             : 'en_US'
        }}
        );
