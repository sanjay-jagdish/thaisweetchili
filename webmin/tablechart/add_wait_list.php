...
jQuery( "#save_booking" ).click(function() {
	...
	if(customer_id>0){
		...
		if(seats_sel>pax){
			...
			jQuery.ajax({
					 url: "tablechart/saveWaitList.php",
					 type: 'POST',
					 async: true,
					 ...
					 success: function(value){
						if(jQuery.isNumeric(value)){	
							modal.open({content: '<font color="green">SUCCESS!</font> Waitlist <b>No. '+value+'</b> has been created.'});
							setTimeout(function(){
		...
		if(first_name!='' && last_name!='' && phone_number!=''){
			...
			jQuery.ajax({
					 url: "tablechart/saveOtherWaitlist.php",
					 type: 'POST',
					 async: true,
...
jQuery('#reload_tables').click(function() {
	...
	jQuery('#seats_difference').html('');
			...
			jQuery.ajax({
					 url: "tablechart/wl_table_list.php",
					 type: 'POST',
...
<div style="float:left; width:200px;">
    <h3 style="margin:0px; padding:0px;">New Waiting List
