...
mysql_query("insert into reservation(reservation_type_id, account_id, date, time, number_people, extra_chairs, note, date_time, duration, approve) 
			 values(1, ".$account_id.", '".date('m/d/Y', strtotime($date))."', '".$time."', ".$guest.", ".$extra_chairs.", '".$notes."', now(), ".$duration.", 2)") or die(mysql_error());
