...
<div class="wrapper">
    ...
    <div style="float:left; margin-top:-6px;">
      ...
      <?php 
		$waitlist_sql = "SELECT id FROM wait_list WHERE date='".date('m/d/Y',strtotime($date_selected))."' AND status=0";
		...
		if($waitlist_cnt>0){
			...
			$waitlist_report = '<font color="red">There '.$lv.' <strong>'.number_format($waitlist_cnt,0).'</strong> record'.$s.' on the list.</font>';
		}else{
			$waitlist_report = 'Ther are no guests on the list.';
		}
		?>
      <div style="float:left; background-color:#FFF; margin:0px; height:20px; border-top: solid 2px #fc9;  border-bottom: solid 2px #fc9; padding:3px;"> <?php echo $waitlist_report; ?></div>
  ...
  <?php
	...
	?>
      	  </div>        	  <div id="chartdate" style="float:left;"></div>
