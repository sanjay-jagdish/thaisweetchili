    ...
    <div class="page-content">
    	<div class="typeselection">
           ...
           <!-- <span id="ta2">Order Status</span>-->
            ...
            <span id="ta5" <?php if(isset($_GET['tab']) & $_GET['tab']==5){ echo 'class="active"'; }?>>Övriga inställningar</span>
        </div>
       ...
       <!-- <p style="margin:20px 0 0;"><font style="color: #e67e22;">OBS :</font> Aktuell inställning visas med grön bakgrund.</p>-->
        ...
        <!--tab 5-->
<div class="ta5 tas" <?php if(!isset($_GET['tab'])){ echo 'style="display:none"'; } else{ echo 'style="display:block;"'; }?>>
		...
		?>
        <script type="text/javascript">
        	window.location='?page=takeaway-settings&parent=takeaway&tab=5';
        </script>
        <?php	
